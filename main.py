...
if language == "1":
	...
	if name == "Boss" or name == "boss":
		...
		flag = True
		printt("Your pizza can be found at: https://bit.ly/whatyoupaidfor. You have to copy and paste the link in a different tab, or else it will give you an error. Idk why.",0.005)
